...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dylan/mybot_ws-master/install/${idir}'.  Ask the maintainer 'robocpu <robocpu@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dylan/mybot_ws-master/install/lib;/home/dylan/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
