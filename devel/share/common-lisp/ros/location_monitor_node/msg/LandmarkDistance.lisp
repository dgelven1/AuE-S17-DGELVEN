...
(cl:defmethod cl:initialize-instance :after ((m <LandmarkDistance>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LandmarkDistance)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name location_monitor_node-msg:<LandmarkDistance> is deprecated: use location_monitor_node-msg:LandmarkDistance instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <LandmarkDistance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader location_monitor_node-msg:name-val is deprecated.  Use location_monitor_node-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <LandmarkDistance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader location_monitor_node-msg:distance-val is deprecated.  Use location_monitor_node-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LandmarkDistance>)))
  ...
  "location_monitor_node/LandmarkDistance")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LandmarkDistance)))
  "Returns string type for a message object of type 'LandmarkDistance"
  "location_monitor_node/LandmarkDistance")
